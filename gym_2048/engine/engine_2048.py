...
class Engine:
    ...
    def move(self, direction):
        ...
        prev_empty_cells = self.count_empty_cells()
        ...
        curr_empty_cells = self.count_empty_cells()
        if curr_empty_cells > prev_empty_cells:
            reward += curr_empty_cells-prev_empty_cells
